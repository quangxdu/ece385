...
// 
// Generated using ACDS version 14.0 200 at 2015.05.04.01:32:23
...
module usb_system_mm_interconnect_0 (
	...
	wire  [104:0] cmd_mux_001_src_data;                                                      // cmd_mux_001:src_data -> cpu_jtag_debug_module_agent:cp_data
	...
	wire    [6:0] cmd_mux_002_src_channel;                                                   // cmd_mux_002:src_channel -> clocks_pll_slave_agent:cp_channel
	...
	wire    [6:0] cmd_mux_003_src_channel;                                                   // cmd_mux_003:src_channel -> clock_crossing_io_s0_agent:cp_channel
	...
	wire    [6:0] cmd_mux_004_src_channel;                                                   // cmd_mux_004:src_channel -> keycode_s1_agent:cp_channel
	...
	wire  [105:0] keycode_2_s1_agent_rf_source_data;                                         // keycode_2_s1_agent:rf_source_data -> keycode_2_s1_agent_rsp_fifo:in_data
	...
	wire  [105:0] keycode_2_s1_agent_rsp_fifo_out_data;                                      // keycode_2_s1_agent_rsp_fifo:out_data -> keycode_2_s1_agent:rf_sink_data
	wire          keycode_2_s1_agent_rsp_fifo_out_ready;                                     // keycode_2_s1_agent:rf_sink_ready -> keycode_2_s1_agent_rsp_fifo:out_ready
	wire          keycode_2_s1_agent_rdata_fifo_src_valid;                                   // keycode_2_s1_agent:rdata_fifo_src_valid -> keycode_2_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] keycode_2_s1_agent_rdata_fifo_src_data;                                    // keycode_2_s1_agent:rdata_fifo_src_data -> keycode_2_s1_agent:rdata_fifo_sink_data
	wire          keycode_2_s1_agent_rdata_fifo_src_ready;                                   // keycode_2_s1_agent:rdata_fifo_sink_ready -> keycode_2_s1_agent:rdata_fifo_src_ready
	wire          cmd_mux_006_src_endofpacket;                                               // cmd_mux_006:src_endofpacket -> keycode_2_s1_agent:cp_endofpacket
	wire          cmd_mux_006_src_valid;                                                     // cmd_mux_006:src_valid -> keycode_2_s1_agent:cp_valid
	wire          cmd_mux_006_src_startofpacket;                                             // cmd_mux_006:src_startofpacket -> keycode_2_s1_agent:cp_startofpacket
	wire  [104:0] cmd_mux_006_src_data;                                                      // cmd_mux_006:src_data -> keycode_2_s1_agent:cp_data
	wire    [6:0] cmd_mux_006_src_channel;                                                   // cmd_mux_006:src_channel -> keycode_2_s1_agent:cp_channel
	wire          cmd_mux_006_src_ready;                                                     // keycode_2_s1_agent:cp_ready -> cmd_mux_006:src_ready
	...
	wire  [104:0] cpu_jtag_debug_module_agent_rp_data;                                       // cpu_jtag_debug_module_agent:rp_data -> router_003:sink_data
	...
	wire          keycode_2_s1_agent_rp_endofpacket;                                         // keycode_2_s1_agent:rp_endofpacket -> router_008:sink_endofpacket
	wire          keycode_2_s1_agent_rp_valid;                                               // keycode_2_s1_agent:rp_valid -> router_008:sink_valid
	wire          keycode_2_s1_agent_rp_startofpacket;                                       // keycode_2_s1_agent:rp_startofpacket -> router_008:sink_startofpacket
	wire  [104:0] keycode_2_s1_agent_rp_data;                                                // keycode_2_s1_agent:rp_data -> router_008:sink_data
	wire          keycode_2_s1_agent_rp_ready;                                               // router_008:sink_ready -> keycode_2_s1_agent:rp_ready
	...
	altera_merlin_slave_agent #(
		...
		.rdata_fifo_sink_ready   (keycode_2_s1_agent_rdata_fifo_src_ready),       // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (keycode_2_s1_agent_rdata_fifo_src_valid),       //                .valid
		.rdata_fifo_sink_data    (keycode_2_s1_agent_rdata_fifo_src_data),        //                .data
	...
	usb_system_mm_interconnect_0_rsp_demux rsp_demux_006 (
		.clk                (clk_clk_clk),                             //       clk.clk
		.reset              (cpu_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
