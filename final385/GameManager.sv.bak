...
always_ff @(posedge shiftUp)//set sprite 10 and 11 to the new arrows from strip
begin
...
always_ff @(posedge shiftUp)//shift 10 and 11 into 8 and 9 etc
begin
	spriteID1=4'hF;
	spriteID2=spriteID4;
	spriteID3=spriteID5;
...
always_ff @(posedge arrowClk)//move all sprites up 1 pixel
begin
	posX2=posX2in;
	posX3=posX3in;
	posX4=posX4in;
